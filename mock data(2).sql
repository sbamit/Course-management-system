...
insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('CE_100','Buiding blocks',1.50,'S','CE 300','CE',1,1);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('MME_211','Chemical analysis',3.00,'T','MME 211','MME',2,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('ME_201','Basic Machine Design',4.00,'T','ME 201','ME',2,1);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('EEE_302','Micro processor',1.50,'S','EEE 302','EEE',3,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('CSE_217','Discrete math',3.00,'T','CSE 217','CSE',2,1);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('CE_413','Irrigation engineering',2.00,'T','CE 413','CE',4,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('IPE_107','Machine basics',3.00,'T','IPE 107','IPE',1,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('EEE_105','Electrical circuits',4.00,'T','EEE 105','EEE',1,1);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('IPE_320','Machine controller',1.50,'S','IPE 320','IPE',3,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('CE_326','Fluid dynamics sessional',1.50,'S','CE 326','CE',3,1);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('CE_349','Kinematics',3.00,'T','CE 349','CE',3,1);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('MATH_111','Differentiation',3.00,'T','MATH 111','IPE',1,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('PHYSICS_127','Crystallography',4.00,'T','PHYSICS 127','IPE',1,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('ME_243','Fluid dynamics',4.00,'T','ME 243','ME',2,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('ME_232','Thermodynamics sessional',1.50,'S','ME 232','ME',2,2);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('EEE_238','Pw generation',1.50,'S','EEE 238','EEE',2,1);

insert into course (course_ID,course_name,course_credit,course_type,course_no,dept,level,term)
values('EEE_223','Nanotechnology',3.00,'S','EEE 206','EEE',2,1);
...
insert into student_course (student_ID,course_ID)
values('0906181','EEE_215');

insert into student_course (student_ID,course_ID)
values('0704082','MME_402');

insert into student_course (student_ID,course_ID)
values('0910001','ME_231');

insert into student_course (student_ID,course_ID)
values('1006041','EEE_206');

insert into student_course (student_ID,course_ID)
values('0702021','CE_401');

insert into student_course (student_ID,course_ID)
values('0802031','CE_326');

insert into student_course (student_ID,course_ID)
values('0802121','CE_326');

insert into student_course (student_ID,course_ID)
values('1005081','CSE_217');

insert into student_course (student_ID,course_ID)
values('1005121','CSE_217');

insert into student_course (student_ID,course_ID)
values('1006171','EEE_206');

insert into student_course (student_ID,course_ID)
values('1006043','EEE_206');

insert into student_course (student_ID,course_ID)
values('1006122','EEE_206');

insert into student_course (student_ID,course_ID)
values('0902022','CE_200');

insert into student_course (student_ID,course_ID)
values('0902127','CE_200');

insert into student_course (student_ID,course_ID)
values('0902057','CE_200');
...
insert into teacher_course (teacher_ID,course_ID)
values('cse001','CSE_404');

insert into teacher_course (teacher_ID,course_ID)
values('cse002','CSE_211');

insert into teacher_course (teacher_ID,course_ID)
values('ce0046','CE_401');

insert into teacher_course (teacher_ID,course_ID)
values('eee093','EEE_206');

insert into teacher_course (teacher_ID,course_ID)
values('mme087','MME_402');

insert into teacher_course (teacher_ID,course_ID)
values('ce0077','CE_309');

insert into teacher_course (teacher_ID,course_ID)
values('eee104','EEE_215');

insert into teacher_course (teacher_ID,course_ID)
values('cse003','CSE_300');

insert into teacher_course (teacher_ID,course_ID)
values('cse005','CSE_311');

insert into teacher_course (teacher_ID,course_ID)
values('cse001','CSE_301');

insert into teacher_course (teacher_ID,course_ID)
values('cse032','CSE_402');

insert into teacher_course (teacher_ID,course_ID)
values('ce0055','CE_401');

insert into teacher_course (teacher_ID,course_ID)
values('eee073','EEE_206');

insert into teacher_course (teacher_ID,course_ID)
values('mme012','MME_402');

insert into teacher_course (teacher_ID,course_ID)
values('ce0027','CE_309');

insert into teacher_course (teacher_ID,course_ID)
values('eee101','EEE_215');

insert into teacher_course (teacher_ID,course_ID)
values('cse012','CSE_401');

insert into teacher_course (teacher_ID,course_ID)
values('cse021','CSE_401');
