<html>
    <head>
        <title>Teachers Course List Page</title>
    ...
    <body>
         <div id="all_content">
             ...
             <div id="side_bar">
                <?php echo anchor('homepages/teachers_homepage', 'Home', array('title' => 'Go Home')); ?>
                 <?php echo "<br/>" ;?>
                 <?php echo anchor('homepages/teachers_homepage', 'Back', array('title' => 'Go Back')); ?>
                <?php echo "<br/>"; ?>
                <?php echo anchor('welcome/logout', 'Log out', array('title' => 'Logout')); ?>
              </div>           
        
            <div id="label">
                <h3>Assigned Courses :: <?php echo " ".$this->session->userdata('firstname')." ".$this->session->userdata('lastname'); ?> </h3>
            </div>
